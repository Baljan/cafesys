...
TITLE_TEMPLATES = {
    "friend_request_denied": ugettext_lazy(
        """%(requestee)s denied your friend request"""
    ),
    "friend_request_accepted": ugettext_lazy(
        """You are now friends with %(requestee)s"""
    ),
    "friend_request_received": ugettext_lazy(
        """You have received a friend request from %(requestor)s"""
    ),
    "friend_request_canceled": ugettext_lazy(
        """The friend request from %(requestor)s was canceled"""
    ),
...
"""
    ...
    "friend_request_received": ugettext_lazy(
        """You have received a friend request from %(requestor)s. Friends can sign each other up for work shifts.
...
"""
    ...
    "added_to_shift": ugettext_lazy(
        """You were signed up for %(shift)s.

See your shifts here: %(profile_url)s
"""
    ),
    "removed_from_shift": ugettext_lazy(
        """You were removed from %(shift)s.
