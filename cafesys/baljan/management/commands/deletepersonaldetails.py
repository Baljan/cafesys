...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        print(
            "Number of non-excluded profiles: %d" %
        ...
        if not real_run_opt:
            print(
                "This is a dry-run. To actually modify data please supply the flag --dangerously-modify-database"
            )
        else:
            ...
            non_excluded_profiles.update(mobile_phone=None)
            print("Done!")
