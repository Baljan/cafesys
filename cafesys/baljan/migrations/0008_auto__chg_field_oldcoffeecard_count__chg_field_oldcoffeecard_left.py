...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OldCoffeeCard.count'
        db.alter_column('baljan_oldcoffeecard', 'count', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'OldCoffeeCard.left'
        db.alter_column('baljan_oldcoffeecard', 'left', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'OldCoffeeCard.count'
        db.alter_column('baljan_oldcoffeecard', 'count', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'OldCoffeeCard.left'
        db.alter_column('baljan_oldcoffeecard', 'left', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'OdOMHJIo'", 'unique': 'True', 'max_length': '8'}),
