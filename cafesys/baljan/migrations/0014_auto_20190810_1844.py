    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                default="little",
                help_text='"Byte order" för långa RFID-nummer (mer än fyra bytes). Vissa läsare byter ordning för nummer längre än fyra bytes.',
                max_length=6,
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                choices=[(10, "decimal"), (16, "hexadecimal")],
                default=10,
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[("little", "little endian"), ("big", "big endian")],
                default="little",
                help_text='"Byte order" för korta RFID-nummer (fyra bytes). Oftast "little endian".',
                max_length=6,
                verbose_name="kort byte order",
            ),
        ),
    ]
