...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OldCoffeeCard.created'
        db.alter_column('baljan_oldcoffeecard', 'created', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'OldCoffeeCard.created'
        db.alter_column('baljan_oldcoffeecard', 'created', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'flEKhElU'", 'unique': 'True', 'max_length': '8'}),
