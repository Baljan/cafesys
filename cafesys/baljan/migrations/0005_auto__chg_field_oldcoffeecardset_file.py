...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OldCoffeeCardSet.file'
        db.alter_column('baljan_oldcoffeecardset', 'file', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'OldCoffeeCardSet.file'
        db.alter_column('baljan_oldcoffeecardset', 'file', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'BPKEGWLm'", 'unique': 'True', 'max_length': '8'}),
