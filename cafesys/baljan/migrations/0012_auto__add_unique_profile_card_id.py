...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Profile', fields ['card_id']
        db.create_unique('baljan_profile', ['card_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Profile', fields ['card_id']
        db.delete_unique('baljan_profile', ['card_id'])
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'tfuJPtHK'", 'unique': 'True', 'max_length': '8'}),
