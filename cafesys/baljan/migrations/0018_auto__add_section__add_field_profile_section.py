...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('baljan_section', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('baljan', ['Section'])

        # Adding field 'Profile.section'
        db.add_column('baljan_profile', 'section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['baljan.Section'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Section'
        db.delete_table('baljan_section')

        # Deleting field 'Profile.section'
        db.delete_column('baljan_profile', 'section_id')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'Q0wKpZLY'", 'unique': 'True', 'max_length': '8'}),
        ...
        'baljan.profile': {
            ...
            'private_key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25'}),
        ...
        'baljan.refillseries': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issued': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 22)'}),
            'least_valid_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 22)'}),
            'made': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'made_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
