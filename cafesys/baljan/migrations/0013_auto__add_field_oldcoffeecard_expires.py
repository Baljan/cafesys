...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OldCoffeeCard.expires'
        db.add_column('baljan_oldcoffeecard', 'expires', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OldCoffeeCard.expires'
        db.delete_column('baljan_oldcoffeecard', 'expires')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'hqNlUD58'", 'unique': 'True', 'max_length': '8'}),
