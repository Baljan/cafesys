...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Order', fields ['put_at']
        db.create_index('baljan_order', ['put_at'])


    def backwards(self, orm):
        
        # Removing index on 'Order', fields ['put_at']
        db.delete_index('baljan_order', ['put_at'])
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'4po4sTpH'", 'unique': 'True', 'max_length': '8'}),
        ...
        'baljan.refillseries': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issued': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 12, 1)'}),
            'least_valid_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 1)'}),
            'made': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'made_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
