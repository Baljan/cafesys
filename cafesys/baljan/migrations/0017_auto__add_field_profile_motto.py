...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('baljan_profile', 'motto', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.motto'
        db.delete_column('baljan_profile', 'motto')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'EwNP9sR2'", 'unique': 'True', 'max_length': '8'}),
        ...
        'baljan.profile': {
            ...
            'private_key': ('django.db.models.fields.CharField', [], {'default': "'fooo'", 'unique': 'True', 'max_length': '25'}),
        ...
        'baljan.refillseries': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issued': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 18)'}),
            'least_valid_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 18)'}),
            'made': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'made_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
