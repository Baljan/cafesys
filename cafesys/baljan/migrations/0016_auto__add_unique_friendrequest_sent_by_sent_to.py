...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'FriendRequest', fields ['sent_by', 'sent_to']
        db.create_unique('baljan_friendrequest', ['sent_by_id', 'sent_to_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FriendRequest', fields ['sent_by', 'sent_to']
        db.delete_unique('baljan_friendrequest', ['sent_by_id', 'sent_to_id'])
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'3yCHs2CG'", 'unique': 'True', 'max_length': '8'}),
        ...
        'baljan.profile': {
            ...
            'private_key': ('django.db.models.fields.CharField', [], {'default': "'wGFCFpw6kSrffKoW2r1MAxqPQ'", 'unique': 'True', 'max_length': '25'}),
        ...
        'baljan.refillseries': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issued': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 9)'}),
            'least_valid_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 9)'}),
            'made': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'made_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
