...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OldCoffeeCard.user'
        db.alter_column('baljan_oldcoffeecard', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))


    def backwards(self, orm):
        
        # Changing field 'OldCoffeeCard.user'
        db.alter_column('baljan_oldcoffeecard', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'W4fb0i97'", 'unique': 'True', 'max_length': '8'}),
