...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.fb_access_token'
        db.alter_column('baljan_profile', 'fb_access_token', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.fb_access_token'
        db.alter_column('baljan_profile', 'fb_access_token', self.gf('django.db.models.fields.CharField')(max_length=150))
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'OQo58SnJ'", 'unique': 'True', 'max_length': '8'}),
        ...
        'baljan.profile': {
            ...
            'private_key': ('django.db.models.fields.CharField', [], {'default': "'RK0uvBomftLDQzwIq6GaMi02t'", 'unique': 'True', 'max_length': '25'}),
        ...
        'baljan.refillseries': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issued': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 6)'}),
            'least_valid_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 6)'}),
            'made': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'made_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
