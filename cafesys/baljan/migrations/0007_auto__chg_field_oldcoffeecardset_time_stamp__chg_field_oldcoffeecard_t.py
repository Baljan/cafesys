...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OldCoffeeCardSet.time_stamp'
        db.alter_column('baljan_oldcoffeecardset', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'OldCoffeeCard.time_stamp'
        db.alter_column('baljan_oldcoffeecard', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'OldCoffeeCardSet.time_stamp'
        db.alter_column('baljan_oldcoffeecardset', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'OldCoffeeCard.time_stamp'
        db.alter_column('baljan_oldcoffeecard', 'time_stamp', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'mwMPk11l'", 'unique': 'True', 'max_length': '8'}),
