...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RefillSeries.add_to_group'
        db.add_column('baljan_refillseries', 'add_to_group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.Group'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RefillSeries.add_to_group'
        db.delete_column('baljan_refillseries', 'add_to_group_id')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'yrDFZfIb'", 'unique': 'True', 'max_length': '8'}),
            ...
            'value': ('django.db.models.fields.PositiveIntegerField', [], {'default': '250'})
        },
        'baljan.boardpost': {
        ...
        'baljan.friendrequest': {
            'Meta': {'unique_together': "(('sent_by', 'sent_to'),)", 'object_name': 'FriendRequest'},
        ...
        'baljan.profile': {
            ...
            'fb_access_token': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '150', 'null': 'True', 'blank': 'True'}),
            ...
            'motto': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'private_key': ('django.db.models.fields.CharField', [], {'default': "'XQSyNw1DMTE7AkEfZxENxmSBX'", 'unique': 'True', 'max_length': '25'}),
            'section': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['baljan.Section']", 'null': 'True', 'blank': 'True'}),
        ...
        'baljan.refillseries': {
            ...
            'add_to_group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.Group']", 'null': 'True'}),
            ...
            'code_value': ('django.db.models.fields.PositiveIntegerField', [], {'default': '250'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issued': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 9)'}),
            'least_valid_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 9, 9)'}),
            'made': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'made_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
