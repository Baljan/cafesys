...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.fb_access_token'
        db.add_column('baljan_profile', 'fb_access_token', self.gf('django.db.models.fields.CharField')(default=u'', max_length=150, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.fb_access_token'
        db.delete_column('baljan_profile', 'fb_access_token')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'dSCtPlpi'", 'unique': 'True', 'max_length': '8'}),
        ...
        'baljan.profile': {
            ...
            'fb_access_token': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '150', 'blank': 'True'}),
            ...
            'private_key': ('django.db.models.fields.CharField', [], {'default': "'WMAAKpnkh7lfzSejHamEnCWd8'", 'unique': 'True', 'max_length': '25'}),
        ...
        'baljan.refillseries': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issued': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 10, 3)'}),
            'least_valid_until': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 3)'}),
            'made': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'made_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
