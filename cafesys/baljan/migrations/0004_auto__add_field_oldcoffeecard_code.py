...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OldCoffeeCard.code'
        db.add_column('baljan_oldcoffeecard', 'code', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OldCoffeeCard.code'
        db.delete_column('baljan_oldcoffeecard', 'code')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'KVGq5cTu'", 'unique': 'True', 'max_length': '8'}),
