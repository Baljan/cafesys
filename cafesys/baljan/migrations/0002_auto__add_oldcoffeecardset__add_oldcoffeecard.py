...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OldCoffeeCardSet'
        db.create_table('baljan_oldcoffeecardset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('set_id', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('baljan', ['OldCoffeeCardSet'])

        # Adding model 'OldCoffeeCard'
        db.create_table('baljan_oldcoffeecard', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['baljan.OldCoffeeCardSet'])),
            ('card_id', self.gf('django.db.models.fields.IntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')()),
            ('time_stamp', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal('baljan', ['OldCoffeeCard'])


    def backwards(self, orm):
        
        # Deleting model 'OldCoffeeCardSet'
        db.delete_table('baljan_oldcoffeecardset')

        # Deleting model 'OldCoffeeCard'
        db.delete_table('baljan_oldcoffeecard')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'eXGpZoT9'", 'unique': 'True', 'max_length': '8'}),
