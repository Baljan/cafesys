    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default=baljan.models.generate_balance_code, help_text="To create a bulk of codes, <a href='../../refillseries/add'>create a new refill series</a> instead.", max_length=8, unique=True, verbose_name='code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_key', models.CharField(default=baljan.models.generate_private_key, max_length=25, unique=True, verbose_name='private key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('made', models.DateTimeField(auto_now_add=True, help_text='when the object was created', verbose_name='made at')),
                ('issued', models.DateField(default=baljan.models.default_issued, verbose_name='issued')),
                ('least_valid_until', models.DateField(default=baljan.models.default_least_valid_until, verbose_name='least valid until')),
