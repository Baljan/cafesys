...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OldCoffeeCard.imported'
        db.add_column('baljan_oldcoffeecard', 'imported', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OldCoffeeCard.imported'
        db.delete_column('baljan_oldcoffeecard', 'imported')
    ...
    models = {
        ...
        'baljan.balancecode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'EGaNvagU'", 'unique': 'True', 'max_length': '8'}),
