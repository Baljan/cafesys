...
urlpatterns = (
    ...
    path(
        "pdf/shift-combinations/<slug:sem_name>",
        views.shift_combinations_pdf,
        name="shift_combinations_pdf",
    ),
    path(
        "pdf/shift-combinations-form/<slug:sem_name>",
        views.shift_combination_form_pdf,
        name="shift_combination_form_pdf",
    ),
    path(
    ...
    path(
        "high-score/<int:year>/<int:week>/<int:location>",
        views.high_score,
        name="high_score",
    ),
